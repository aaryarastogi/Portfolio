...
const AutomaticQuote= () => {
  ...
  <div className='overflow-hidden bg-[#0F1630]'>
    ...
    <Link to='/project' className='bg-gradient-to-tr from-pink-700 to-blue-800 hover:opacity-75  leading-3 text-center font-normal text-xl my-6  w-40 h-10 py-3 rounded-md cursor-pointer'>Project Link</Link>
    </div>
    </div>
    ...
    <div className='flex flex-col mt-10 gap-10 text-justify pl-24 pr-16 max-w-7xl w-[92%] m-auto'>
      ...
      <div className='flex flex-row gap-4 mb-4'>
      <Link to='/project' className='bg-gradient-to-tr from-pink-700 to-blue-800 hover:opacity-75 capitalize leading-3 text-center font-medium text-base mb-4 w-auto py-3 px-2 rounded-md cursor-pointer'><a href='https://minequotegenerator.netlify.app/' target={'_blank'}>Project Link</a></Link>
