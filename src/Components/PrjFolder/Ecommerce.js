  ...
  <div className='overflow-hidden bg-[#0F1630]'>
    ...
    <div className="w-full h-screen/4 overflow-hidden bg-[#0F1630]"> 
      <div className='place-items-center my-72 grid'>
        <h1 className='md:text-6xl text-2xl font-bold text-center bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 bg-clip-text text-transparent italic uppercase mb-4'>Cartify</h1>
        <br/>
        ...
        <p className='bg-gradient-to-tr from-pink-700 to-blue-800 hover:opacity-75  leading-3 text-center font-normal text-xl my-6  w-40 h-10 py-3 rounded-md cursor-pointer'>
          <a href='https://ecommerce-website-odt2.onrender.com/' target={'_blank'}>Project Link</a></p>
      </div>
    ...
    <div className='flex flex-col mt-10 gap-10 text-justify max-w-7xl w-[92%] m-auto'>
      ...
      <div className='flex flex-row gap-4 mb-4'>
      <p className='bg-gradient-to-tr from-pink-700 to-blue-800 hover:opacity-75 capitalize leading-3 text-center font-medium text-base mb-4 w-auto py-3 px-2 rounded-md cursor-pointer'><a href='https://github.com/aaryarastogi/Ecommerce-web-app' target={'_blank'}>Github Link</a></p>
