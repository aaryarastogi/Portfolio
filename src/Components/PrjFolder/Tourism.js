  ...
  <div className='overflow-hidden bg-[#0F1630]'>
    ...
    <div className="w-full h-screen/4 overflow-hidden bg-[#0F1630]"> 
      <div className='place-items-center my-72 grid'>
        ...
        <Link to = 'https://dreamdestination-website.netlify.app/' target='_blank' className='bg-gradient-to-tr from-pink-700 to-blue-800 hover:opacity-75  leading-3 text-center font-normal text-xl my-6  w-40 h-10 py-3 rounded-md cursor-pointer'>
          Project Link
        </Link>
      </div>
    </div>
    ...
    <div className='flex flex-col mt-10 gap-10 text-justify max-w-7xl w-[92%] m-auto'>
      ...
      <div>
        ...
        <p className='text-xl mb-4 text-slate-500'>Facilitates seamless booking experiences for various travel necessities by integrated the Razorpay payment gateway.</p>
        ...
        <p className='text-xl mb-4 text-slate-500 '>After booking, they will get confirmation mail on their regsitered mail id.</p>
        <p className='text-xl mb-4 text-slate-500 '>Also implemented the rule-based chatbot for booking tickets.</p>
      ...
      <div className='flex flex-row gap-4 mb-4'>
      <p className='bg-gradient-to-tr from-pink-700 to-blue-800 hover:opacity-75 capitalize leading-3 text-center font-medium text-base mb-4 w-auto py-3 px-2 rounded-md cursor-pointer'><a href='https://github.com/aaryarastogi/Tourism-Website' target={'_blank'}>Github Link</a></p>
