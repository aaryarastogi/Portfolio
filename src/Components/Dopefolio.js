...
const Dopefolio = () => {
  ...
  <div className='overflow-hidden'>
    ...
    <h1 className='md:text-6xl text-2xl font-bold text-center text-slate-800 uppercase mb-4'>Dopefolio</h1>
    <br/>
    <h3 className='md:text-2xl text-md text-center items-center justify-center text-gray-800 md:ml-20 md:mr-14'>This page contains the case study of Dopefolio Open-Source Project which includes the Project Overview, Tools Used and Live Links to the official product.</h3>
    <p className='bg-slate-400 hover:bg-slate-200 hover:scale-110 transition-all duration-100 ease-in uppercase leading-3 text-center font-medium text-xl my-6  w-44 h-16 pt-6 rounded-md cursor-pointer'><a href='' target={'_blank'}>Project Link</a></p>
    </div>
    </div>

    <div className='flex flex-col mt-10 gap-10 text-justify pl-24 pr-16 max-w-7xl w-[92%] m-auto'>
      <img src={dopefolio} className='w-[50rem]'></img>
      <h1 className='text-3xl font-bold text-gray-700 capitalize'>Project Overview</h1>
      <div>
      <p className='text-xl mb-4 text-gray-600'>Dopefolio is an Open-Source project which is a simple and clean multi-page portfolio website template for developers. I created this project for developers to quickly build a good-looking and fast-performing multi-page portfolio without having to code their portfolio from scratch.</p>
      <p className='text-xl mb-4 text-gray-600'>Since the launch of this project, It has received more than 2k stars on Github and it has also got featured on hundreds of sites and CSS-tricks.com has also featured this template as the hottest frontend tool of 2021 in one of their articles which you can find here</p>
      ...
      <p className='text-xl mb-4 text-gray-600 '>It has many other features like Dopefolio's repo contains a playground link which people can use to test the template with different theme colours to find their own preferred primary colour for the template.</p>
      ...
      <div className='flex flex-row gap-4 mb-4'>
      <p className='bg-slate-400 hover:bg-slate-200 transition-all duration-100 ease-in uppercase leading-3 text-center font-medium text-base mb-4 w-auto py-3 px-2 rounded-md cursor-pointer'><a href='' target={'_blank'}>Project Link</a></p>
