...
const About = () => {
  return (
    <div className='w-full bg-slate-200 bg-fixed'>
      <h1 className='flex text-center items-center justify-center uppercase pt-10 text-4xl font-bold transition-all duration-100 md:hover:scale-110'>About Me</h1>
      <hr className='w-10 absolute flex items-center justify-center my-5 h-2 bg-slate-400 rounded-lg md:ml-[49%] ml-[44%]'/>
      <p className='flex items-center justify-center text-center md:text-2xl text-md md:mx-40 mx-2 my-10'>Here you will find more information about me, what I do, and my current skills mostly in terms of programming and technology</p>
      {/* grid part */}
      <div className='grid md:grid-cols-2 grid-rows-2'>
        ...
        <h1 className='md:text-4xl text-3xl font-bold font-serif md:ml-24 ml-4 md:my-8 my-4'>Get to know me!</h1>
        ...
        <div className='justify-start md:ml-24 ml-4 my-3 bg-slate-500 rounded-md w-28 text-center uppercase h-10 pt-2 font-semibold hover:bg-slate-300 cursor-pointer transition-all duration-100 ease-in'><Link to='/contact'>Contact</Link></div>
      </motion.div>
      <motion.div
      initial={{
        x:100,
    ...
    transition={{
      ...
      duration:2,
       ...
       className='flex flex-col justify-start'>
      <h1 className='md:text-4xl text-3xl font-bold font-serif ml-4 md:my-8 my-4'>My Skills</h1>
      <div className='grid grid-cols-5 mx-4 leading-8 gap-6'>
        <img src={react} alt='React Js' className='w-20 h-20 rounded-full cursor-pointer hover:scale-110 hover:border-2' title='React JS'/>
      ...
      <div className='grid md:grid-cols-3 md:-mt-56 -mt-52'>
        ...
        <div className='md:-mt-80 md:ml-16 ml-4 justify-start '>
          <h1 className='text-4xl font-semibold mb-4 md:ml-0'>Frontend Developer</h1>
          <h2 className='text-xl my-2'>React Js</h2>
          <h2 className='text-xl my-2'>Designing(kinda)</h2>
          <h2 className='text-xl my-2'>Listening Music</h2>
        </div>
        {/* image */}
        <motion.img 
        initial={{scale: 0.5 }}
        ...
        <div className='md:-mt-80 md:ml-16 ml-4 justify-start md:mb-0 mb-4'>
          <h1 className='text-4xl font-semibold mb-4'>Backend Developer</h1>
          <h2 className='text-xl my-2'>Express JS</h2>
          <h2 className='text-xl my-2'>NodeJS</h2>
          <h2 className='text-xl my-2 capitalize'>Explore new Technologies</h2>
        </div>
      </div>
